...
class MatchGame extends Component {
  ...
  playAgain = () => {
    this.setState({score: 0, time: 60, gameCompleted: false, tabId: 'FRUIT'})
  }

  render() {
    const {tabId, score, time, randomImage, gameCompleted} = this.state
        ...
        <nav className="navbar-container">
          ...
          <ul className="score-time-container">
            ...
            <li className="clock-container">
              ...
              />
              <p className="time-sec">{time} sec</p>
            </li>
          </ul>
        </nav>
        ...
        {!gameCompleted && (
          <div className="game-container">
            <div className="match-image-container">
              <img className="match-image" src={randomImage} alt="match" />
            </div>
            <ul className="tabs-container">
              {tabsList.map(eachTab => (
                <TabsList
                  ...
                  textHighlet={eachTab.tabId === tabId}
                />
              ))}
            </ul>
            <ul className="thumbnail-container">
              {filteredImages.map(eachItem => (
                <ThumbnailImages
                  ...
                  thumbnailChange={this.thumbnailChange}
                />
              ))}
            </ul>
          </div>
        ...
        {gameCompleted && (
          <div className="game-over-container">
            <div className="game-over-bg-container">
              <div className="tropy-score-container">
                <img
